...
public static void selectPlusButtonInHSBCGrid(int rowNumber){
    page.querySelector("div.ag-pinned-left-cols-container").querySelector("css=[row-index=\'"+rowNumber+"\']").querySelector("css=[col-id='0']").querySelector("div button").dispatchEvent("click");
}
